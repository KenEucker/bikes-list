      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(["Overview", "Profile", "Team", "Listings", "Events"], (t) => {
            ...
            _push2(`<!--]--></div><div class="mt-6"${_scopeId}><p class="text-muted"${_scopeId}>Overview and management for this community page. Profile, team, listings, and events tabs can be wired to edit views.</p>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            return [
              createVNode("div", { class: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" }, [
                ...
                createVNode("div", { class: "mt-6 flex gap-2 border-b border-border" }, [
                  (openBlock(), createBlock(Fragment, null, renderList(["Overview", "Profile", "Team", "Listings", "Events"], (t) => {
                ...
                createVNode("div", { class: "mt-6" }, [
                  createVNode("p", { class: "text-muted" }, "Overview and management for this community page. Profile, team, listings, and events tabs can be wired to edit views."),
                  createVNode(unref(Link), {
                    href: `${__props.cityBaseUrl}/community/${__props.page.slug}/edit`,
                    class: "mt-4 inline-block text-primary underline"
                  }, {
