      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.sales.length) {
              _push2(`<section class="mt-6"${_scopeId}><h2 class="text-lg font-semibold text-fg"${_scopeId}>For Sale</h2><ul class="mt-2 space-y-2"${_scopeId}><!--[-->`);
              ssrRenderList(__props.sales, (sale) => {
                _push2(`<li class="flex items-center justify-between rounded-token-md border border-border bg-card px-4 py-2"${_scopeId}><a${ssrRenderAttr("href", `${__props.cityBaseUrl}/for-sale/${sale.id}`)} class="font-medium text-primary underline"${_scopeId}>${ssrInterpolate(sale.title)}</a>`);
            ...
            if (__props.rides.length) {
              _push2(`<section class="mt-6"${_scopeId}><h2 class="text-lg font-semibold text-fg"${_scopeId}>Rides</h2><ul class="mt-2 space-y-2"${_scopeId}><!--[-->`);
              ssrRenderList(__props.rides, (ride) => {
                _push2(`<li class="flex items-center justify-between rounded-token-md border border-border bg-card px-4 py-2"${_scopeId}><a${ssrRenderAttr("href", `${__props.cityBaseUrl}/rides/${ride.id}`)} class="font-medium text-primary underline"${_scopeId}>${ssrInterpolate(ride.name)}</a>`);
                _push2(ssrRenderComponent(_sfc_main$2, { status: "pending_review" }, null, _parent2, _scopeId));
                _push2(`</li>`);
              });
              _push2(`<!--]--></ul></section>`);
            ...
            if (!__props.sales.length && !__props.rides.length && !__props.pages.length) {
            ...
            return [
              createVNode("div", { class: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" }, [
                ...
                __props.sales.length ? (openBlock(), createBlock("section", {
                  key: 0,
                  class: "mt-6"
                }, [
                ...
                __props.rides.length ? (openBlock(), createBlock("section", {
                  key: 1,
                  class: "mt-6"
                }, [
                ...
                !__props.sales.length && !__props.rides.length && !__props.pages.length ? (openBlock(), createBlock("p", {
                  key: 3,
