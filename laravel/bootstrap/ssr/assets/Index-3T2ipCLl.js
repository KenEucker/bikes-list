  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        title: `BikesList – ${__props.city.name} – For Sale`
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_gv_select, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<!--[-->`);
                  ssrRenderList(saleTypeOptions.value, ([key, config]) => {
                  ...
                  return [
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(saleTypeOptions.value, ([key, config]) => {
            ...
            _push2(`</div></div><div class="mb-6 flex flex-wrap items-center justify-between gap-4"${_scopeId}><h1 class="govuk-heading-l"${_scopeId}>For Sale</h1>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            ssrRenderList(__props.sales.data, (sale) => {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (saleThumbUrl(sale)) {
                      _push3(`<img${ssrRenderAttr("src", saleThumbUrl(sale))} alt="" class="w-full h-full object-cover"${_scopeId2}>`);
                    } else {
                      _push3(`<span${_scopeId2}>No photo</span>`);
                    }
                    _push3(`</div><div class="min-w-0 flex-1"${_scopeId2}><p class="font-medium text-fg truncate"${_scopeId2}>${ssrInterpolate(sale.title)}</p><p class="text-sm text-muted"${_scopeId2}>${ssrInterpolate(__props.saleTypes[sale.type]?.label || sale.type)} · ${ssrInterpolate(sale.price != null ? `$${Number(sale.price).toLocaleString()}` : "Free")}</p></div>`);
                  } else {
                    return [
                      createVNode("div", { class: "w-16 h-16 shrink-0 rounded-token-sm overflow-hidden bg-muted flex items-center justify-center text-muted text-xs" }, [
                        saleThumbUrl(sale) ? (openBlock(), createBlock("img", {
                          key: 0,
                          src: saleThumbUrl(sale),
                          alt: "",
                          class: "w-full h-full object-cover"
                        }, null, 8, ["src"])) : (openBlock(), createBlock("span", { key: 1 }, "No photo"))
                      ]),
                      createVNode("div", { class: "min-w-0 flex-1" }, [
                        createVNode("p", { class: "font-medium text-fg truncate" }, toDisplayString(sale.title), 1),
                        createVNode("p", { class: "text-sm text-muted" }, toDisplayString(__props.saleTypes[sale.type]?.label || sale.type) + " · " + toDisplayString(sale.price != null ? `$${Number(sale.price).toLocaleString()}` : "Free"), 1)
                      ])
                    ];
                  }
                }),
            ...
            _push2(`<!--]--></ul>`);
            if (__props.sales.data.length === 0) {
              _push2(`<div class="py-12 text-center text-muted"${_scopeId}>No sales found.</div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.sales.prev_page_url || __props.sales.next_page_url) {
              _push2(ssrRenderComponent(_component_gv_pagination, {
                variant: "block",
                "current-page": __props.sales.current_page,
                "previous-href": __props.sales.prev_page_url || void 0,
                "next-href": __props.sales.next_page_url || void 0,
            ...
            return [
              createVNode("div", { class: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" }, [
                ...
                createVNode("div", { class: "mb-6 flex flex-wrap items-center justify-between gap-4" }, [
                  createVNode("h1", { class: "govuk-heading-l" }, "For Sale"),
                ...
                createVNode("ul", { class: "govuk-list govuk-!-margin-top-4 divide-y divide-border border-t border-border" }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.sales.data, (sale) => {
                ...
                __props.sales.data.length === 0 ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "py-12 text-center text-muted"
                }, "No sales found.")) : createCommentVNode("", true),
                __props.sales.prev_page_url || __props.sales.next_page_url ? (openBlock(), createBlock(_component_gv_pagination, {
                  key: 1,
                  variant: "block",
                  "current-page": __props.sales.current_page,
                  "previous-href": __props.sales.prev_page_url || void 0,
