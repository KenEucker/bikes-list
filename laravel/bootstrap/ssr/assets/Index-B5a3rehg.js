        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: `${__props.cityBaseUrl}/moderation/listings`,
              class: "govuk-button",
              role: "button"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Listings queue`);
                } else {
                  return [
                    createTextVNode("Listings queue")
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: `${__props.cityBaseUrl}/moderation/events`,
              class: "govuk-button",
              role: "button"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
