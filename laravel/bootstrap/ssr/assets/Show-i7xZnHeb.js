  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        breadcrumb: ["For Sale", __props.sale.title]
      }, {
        "nav-right": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a${ssrRenderAttr("href", `${__props.cityBaseUrl}/for-sale`)} class="govuk-link"${_scopeId}>Back to For Sale</a>`);
          ...
          if (_push2) {
            ...
            if (__props.moderatorRelayEmail) {
              ...
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                "mailto-subject": `Report: Sale – ${__props.sale.title} – ${__props.sale.id}`
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
