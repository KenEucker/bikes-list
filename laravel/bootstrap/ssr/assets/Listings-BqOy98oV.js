  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        title: `BikesList – ${__props.city.name} – My listings`
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8"${_scopeId}><h1 class="govuk-heading-l"${_scopeId}>My listings</h1>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              items: __props.listings.data || [],
              columns,
              "show-url-fn": (item) => `${__props.cityBaseUrl}/listings/${item.id}`,
              "edit-url-fn": (item) => `${__props.cityBaseUrl}/listings/${item.id}/edit`,
              "status-key": "state"
            ...
            return [
              createVNode("main", { class: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" }, [
                createVNode("h1", { class: "govuk-heading-l" }, "My listings"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Listings.vue");
