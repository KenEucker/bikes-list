        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: `${__props.cityBaseUrl}/dashboard/listings`,
              class: "rounded-token-md border border-border bg-card p-4 no-underline"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-medium text-fg"${_scopeId2}>Listings</span><p class="mt-1 text-2xl font-semibold text-muted"${_scopeId2}>${ssrInterpolate(__props.counts.listings ?? 0)}</p>`);
                } else {
                  return [
                    createVNode("span", { class: "font-medium text-fg" }, "Listings"),
                    createVNode("p", { class: "mt-1 text-2xl font-semibold text-muted" }, toDisplayString(__props.counts.listings ?? 0), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: `${__props.cityBaseUrl}/dashboard/events`,
              class: "rounded-token-md border border-border bg-card p-4 no-underline"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-medium text-fg"${_scopeId2}>Events</span><p class="mt-1 text-2xl font-semibold text-muted"${_scopeId2}>${ssrInterpolate(__props.counts.events ?? 0)}</p>`);
                } else {
                  return [
                    createVNode("span", { class: "font-medium text-fg" }, "Events"),
                    createVNode("p", { class: "mt-1 text-2xl font-semibold text-muted" }, toDisplayString(__props.counts.events ?? 0), 1)
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="font-medium text-fg"${_scopeId2}>Pending</span><p class="mt-1 text-2xl font-semibold text-amber-600 dark:text-amber-400"${_scopeId2}>${ssrInterpolate((__props.counts.pendingListings ?? 0) + (__props.counts.pendingEvents ?? 0) + (__props.counts.pendingPages ?? 0))}</p>`);
                } else {
                  return [
                    createVNode("span", { class: "font-medium text-fg" }, "Pending"),
                    createVNode("p", { class: "mt-1 text-2xl font-semibold text-amber-600 dark:text-amber-400" }, toDisplayString((__props.counts.pendingListings ?? 0) + (__props.counts.pendingEvents ?? 0) + (__props.counts.pendingPages ?? 0)), 1)
                  ];
                }
              }),
              _: 1
