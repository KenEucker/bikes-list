...
import { R as RideForm } from "./RideForm-BO2czDpw.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        title: `BikesList – ${__props.ride.name} – Edit`
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, {
        title: "Edit ride",
        "head-title": `BikesList – ${__props.ride.name} – Edit`,
        breadcrumb: [{ label: "Rides", href: `${__props.cityBaseUrl}/rides` }, { label: __props.ride.name, href: `${__props.cityBaseUrl}/rides/${__props.ride.id}` }, "Edit"],
        city: __props.city,
          ...
          if (_push2) {
            ...
            return [
              createVNode(RideForm, {
                ...
                errors: __props.errors,
                "onUpdate:processing": ($event) => submitting.value = $event
              }, null, 8, ["ride", "guidelines", "managed-community-pages", "audiences", "default-audience-id", "ride-tags", "city-base-url", "errors", "onUpdate:processing"])
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Rides/Edit.vue");
