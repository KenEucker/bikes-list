      ...
      if (useCityLayout({ city: __props.city, cityBaseUrl: __props.cityBaseUrl })) {
        _push(ssrRenderComponent(_sfc_main$1, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="py-12"${_scopeId}><div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8"${_scopeId}><h1 class="govuk-heading-l"${_scopeId}>Account settings</h1><div class="bg-card border border-border p-4 shadow sm:rounded-lg sm:p-8"${_scopeId}>`);
