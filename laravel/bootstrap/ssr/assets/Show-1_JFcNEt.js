...
import { _ as _sfc_main$2 } from "./CityLayout-DXBkMg5Q.js";
import { _ as _sfc_main$3 } from "./ListingCard-bqyS4Ub0.js";
  ...
  setup(__props) {
    ...
    const groupedByDay = computed(() => {
      ...
      for (const event of events) {
        ...
        if (!map.has(dayKey)) map.set(dayKey, { label: start ? start.toLocaleDateString(void 0, { weekday: "long", month: "short", day: "numeric" }) : "Date TBA", events: [] });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="description"${ssrRenderAttr("content", __props.city.description || `Bike listings, events, and community in ${__props.city.name}.`)}${_scopeId}><meta property="og:title"${ssrRenderAttr("content", `BikesList – ${__props.city.name}`)}${_scopeId}><meta property="og:description"${ssrRenderAttr("content", __props.city.description || `Bike listings, events, and community in ${__props.city.name}.`)}${_scopeId}><meta property="og:url"${ssrRenderAttr("content", unref(page).props.seo?.currentUrl || __props.cityBaseUrl)}${_scopeId}><link rel="canonical"${ssrRenderAttr("href", unref(page).props.seo?.currentUrl || __props.cityBaseUrl)}${_scopeId}>`);
          } else {
            return [
              createVNode("meta", {
                name: "description",
                content: __props.city.description || `Bike listings, events, and community in ${__props.city.name}.`
              }, null, 8, ["content"]),
              createVNode("meta", {
                property: "og:title",
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (upcomingEventsSafe.value.length > 0) {
              _push2(`<section class="space-y-4"${_scopeId}><h2 class="text-xl font-semibold text-fg"${_scopeId}>Upcoming events this month</h2>`);
              _push2(ssrRenderComponent(_sfc_main$1, { events: upcomingEventsSafe.value }, null, _parent2, _scopeId));
              _push2(`<a${ssrRenderAttr("href", `${__props.cityBaseUrl}/events`)} class="inline-block text-sm text-primary underline"${_scopeId}>View all events</a></section>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(`</form></section><section class="space-y-4"${_scopeId}><div class="flex flex-wrap items-center justify-between gap-4"${_scopeId}><h2 class="text-xl font-semibold text-fg"${_scopeId}>Listings</h2>`);
            ...
            _push2(`</div>`);
            if (listingsPreviewSafe.value.length > 0) {
              _push2(`<div${_scopeId}><ul class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4"${_scopeId}><!--[-->`);
              ssrRenderList(listingsPreviewSafe.value, (listing) => {
                _push2(`<li${_scopeId}>`);
              ...
              _push2(`<!--]--></ul><a${ssrRenderAttr("href", `${__props.cityBaseUrl}/listings`)} class="inline-block text-sm font-medium text-primary underline"${_scopeId}>View all listings</a></div>`);
            } else {
              _push2(`<p class="text-muted"${_scopeId}>No listings yet.</p>`);
            }
            ...
            return [
              createVNode("div", { class: "govuk-width-container govuk-!-padding-top-8 govuk-!-padding-bottom-8 space-y-10" }, [
                ...
                upcomingEventsSafe.value.length > 0 ? (openBlock(), createBlock("section", {
                  key: 1,
                  class: "space-y-4"
                }, [
                  createVNode("h2", { class: "text-xl font-semibold text-fg" }, "Upcoming events this month"),
                  createVNode(_sfc_main$1, { events: upcomingEventsSafe.value }, null, 8, ["events"]),
                  createVNode("a", {
                    href: `${__props.cityBaseUrl}/events`,
                    class: "inline-block text-sm text-primary underline"
                  }, "View all events", 8, ["href"])
                ...
                createVNode("section", { class: "space-y-4" }, [
                  createVNode("div", { class: "flex flex-wrap items-center justify-between gap-4" }, [
                    createVNode("h2", { class: "text-xl font-semibold text-fg" }, "Listings"),
                  ...
                  listingsPreviewSafe.value.length > 0 ? (openBlock(), createBlock("div", { key: 0 }, [
                    createVNode("ul", { class: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4" }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(listingsPreviewSafe.value, (listing) => {
                        return openBlock(), createBlock("li", {
                          key: listing.id
                        }, [
