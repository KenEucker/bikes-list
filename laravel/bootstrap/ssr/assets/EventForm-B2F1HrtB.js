...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const initialUploadIds = ev.uploads && Array.isArray(ev.uploads) && ev.uploads.length ? [ev.uploads[0].id] : [];
    const form = useForm({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    eventTagsList.value.length ? (openBlock(), createBlock("div", {
                      key: 1,
                      class: "govuk-form-group"
                    }, [
                      createVNode("label", { class: "govuk-label" }, "Tags (optional)"),
                      createVNode("div", { class: "govuk-checkboxes govuk-checkboxes--small" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(eventTagsList.value, ([slug, label]) => {
                ...
                if (_push3) {
                  ...
                  return [
                    ...
                    isGuest.value ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      ...
                      createVNode("p", { class: "govuk-body govuk-!-margin-top-2" }, " Your email is required so we can contact you about this event. You can choose to hide it from the public listing below. ")
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode("div", { class: "rounded-token-md border border-border bg-card p-4" }, [
                        createVNode("h2", { class: "font-medium text-fg" }, "Event community guidelines"),
