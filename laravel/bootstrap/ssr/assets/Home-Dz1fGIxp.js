    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), { title: "BikesList – Cities" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="description" content="Choose a city to view local bike listings, events, and community pages."${_scopeId}><meta property="og:title" content="BikesList – Cities"${_scopeId}><meta property="og:description" content="Choose a city to view local bike listings, events, and community pages."${_scopeId}><meta property="og:url"${ssrRenderAttr("content", unref(page).props.seo?.currentUrl || unref(page).props.urls?.home || "/")}${_scopeId}><link rel="canonical"${ssrRenderAttr("href", unref(page).props.seo?.currentUrl || unref(page).props.urls?.home || "/")}${_scopeId}>`);
          } else {
            return [
              createVNode("meta", {
                name: "description",
                content: "Choose a city to view local bike listings, events, and community pages."
              }),
              createVNode("meta", {
                property: "og:title",
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8"${_scopeId}><h1 class="govuk-heading-xl"${_scopeId}>BikesList</h1><p class="mt-2 text-muted"${_scopeId}>Choose a city to view listings, events, and community pages.</p><div class="mt-8 max-w-md"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" }, [
                ...
                createVNode("p", { class: "mt-2 text-muted" }, "Choose a city to view listings, events, and community pages."),
