    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-12"${_scopeId}><div class="mx-auto max-w-7xl sm:px-6 lg:px-8"${_scopeId}><p class="mb-4 text-sm text-muted"${_scopeId}>Searches you save from a city listings page appear here. No alerts in v1.</p>`);
            ...
            if (__props.savedSearches.length === 0) {
              _push2(`<p class="text-muted"${_scopeId}>No saved searches. Save a search from a city listings page.</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
            ...
            return [
              createVNode("div", { class: "py-12" }, [
                createVNode("div", { class: "mx-auto max-w-7xl sm:px-6 lg:px-8" }, [
                  createVNode("p", { class: "mb-4 text-sm text-muted" }, "Searches you save from a city listings page appear here. No alerts in v1."),
                  ...
                  __props.savedSearches.length === 0 ? (openBlock(), createBlock("p", {
                    key: 1,
                    class: "text-muted"
                  }, "No saved searches. Save a search from a city listings page.")) : createCommentVNode("", true)
                ])
              ])
            ];
          }
